...
## [Unreleased]
 **Tests: compatibilidad con localStorage de Node.js 25+**: Añadido mock global reutilizable de localStorage para tests, importado incondicionalmente en todos los archivos relevantes. Soluciona fallos por localStorage nativo de Node 25 sin métodos funcionales. Los tests pasan en Node.js >=25 sin --localstorage-file.
### Añadido
