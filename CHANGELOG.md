...
- **PiP tablet: salto de posición y zoom fijo en pinch**: El pinch-zoom en PiP de tablet tenía dos problemas: (1) al soltar los dedos la ventana saltaba porque el commit no compensaba el efecto visual del scale-around-origin del preview, y (2) pellizcar repetidamente podía dejar el zoom aparentemente fijo porque el límite visual del preview era más permisivo que el límite real del commit (coverMinScale vs getMinScale). Corregido igualando los límites y aplicando la fórmula de posición visual completa (como desktop) al commitear.
