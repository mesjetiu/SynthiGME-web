...
- **Interacciones PiP más coherentes**: Los tooltips se cierran al mover o escalar un panel para evitar fantasmas, el gesto táctil de dos dedos puede ahora panear y hacer zoom a la vez sobre una PiP, y los gestos de touchpad continúan ligados al mismo panel aunque éste se desplace fuera del cursor mientras dura la interacción.
