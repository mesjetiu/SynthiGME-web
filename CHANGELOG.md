...
### Arreglado
- **Stereo bus routing multicanal no persistía**: El routing de stereo buses (Pan 1-4 L/R, Pan 5-8 L/R) en modo multicanal no se cargaba correctamente al reiniciar la app porque `outputMode` se inicializaba después de cargar el routing, causando que siempre se usara la clave de almacenamiento de modo estéreo.
