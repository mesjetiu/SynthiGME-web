...
- **Paneo y zoom por teclado suaves en PiPs**: Las flechas y `Ctrl` + `+`/`-` dejan de mover o escalar las ventanas flotantes a saltos cuando una PiP tiene el foco. Ahora ambas interacciones se animan con `requestAnimationFrame`, arrancan de inmediato y aceleran de forma progresiva mientras la tecla permanece pulsada.
