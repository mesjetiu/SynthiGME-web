...
### Añadido
- **Panel 4 blueprint v2**: Estructura visual del Panel 4 con 3 filas: 8 voltímetros (placeholder), Sequencer Event Time (placeholder) y Keyboard Output Range con 7 columnas. Implementadas columnas 1-3: Pitch Voltage Converter + Envelope Followers 1-2 (col 1, apilados), Upper Keyboard (col 2) y Lower Keyboard (col 3) con vernier dials, knobs de colores y toggles. Columnas 4-7 como placeholders vacíos. Método `_buildPanel4()` en app.js con creación dinámica de DOM desde blueprint.
