...
- **PiP: auto-lock al abrir primera PiP**: Al extraer el primer panel a PiP (desde un estado sin PiPs), el canvas principal se lleva automáticamente a vista general (zoom mínimo) y se bloquean paneo y zoom. Esto evita mover accidentalmente el fondo mientras se trabaja con paneles flotantes. El usuario puede desbloquear manualmente después. No aplica en restauración de sesión.
