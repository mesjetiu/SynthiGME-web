...
### Añadido
- **Cobertura de tests para assets raster y cleanup de knobs**: Nuevos tests para `RotarySwitch`, `VernierKnob`, `svgInlineLoader` y `Toggle` rasterizado, además de tests estáticos para scripts de generación SVG→PNG e inventario de assets en `src/`, `docs/` y `design/`.
