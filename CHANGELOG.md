...
- **Pinch-zoom PiP fluido en móvil/tablet**: Durante el gesto de pellizco, el panel flotante se previsualiza con un `transform: scale() translate3d()` GPU-only (sin layout ni paint). El resize real se commitea una sola vez al soltar los dedos, eliminando completamente el lag del zoom respecto al gesto táctil.
