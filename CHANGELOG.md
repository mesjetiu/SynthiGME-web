...
### Corregido
- **PiP con modo preview estructural durante interacción**: Durante pan, zoom y resize activos el panel extraído entra temporalmente en un modo preview que oculta el subárbol interactivo y deja visible solo el fondo del panel, restaurando el DOM vivo al quedar idle. En la medición Chromium/Linux el escenario `pip-zoom-panel-1` pasó de 12.69 a 14.69 FPS, con `LayoutDuration` de 0.239s a 0.084s y `TaskDuration` de 2.635s a 1.649s.
