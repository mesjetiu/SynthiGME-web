...
### Cambiado
- **PiP: contenido sin márgenes negros (cover)**: El panel dentro del PiP se adapta al eje más próximo, llenándolo completamente. Al redimensionar desde bordes, la escala se recalcula automáticamente para mantener el cover. Solo puede haber desbordamiento (con scroll) en un eje, nunca márgenes negros en ambos.
