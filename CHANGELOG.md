...
- **Transición suave al extraer/devolver PiP**: Al abrir o devolver un panel flotante se anima ahora la propia ventana PiP real, con un movimiento equivalente a pan+zoom del usuario en vez de un snapshot especial. Esto elimina desajustes entre paneles durante la transformación y reduce el retardo antes de que empiece el detach, manteniendo una frenada final más lenta y natural.
